...
plt.plot(d3x, d3ylog, color='g', marker='None')
plt.plot(d1x, d1ylog, color='b', marker='None')

plt.axis([0, 600000, 0, 4.0])
plt.xlabel('steps', fontsize=18)
plt.ylabel('diff   (log)', fontsize=18)
plt.title('Fig.4', fontsize=20, fontweight='bold')
plt.legend(['実装１ 1e-5', '実装１ 1e-4', '実装２'], prop=fp, loc='lower right')
